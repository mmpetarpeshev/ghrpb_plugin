    ...
    stage ("Install the plugin to selected jenkins instance...") {
      steps {
        script {
          ...
          echo "$CRUMB_URL"
          CRUMB = sh (script: """'http://admin:1178ebd333f5adbab57b3e98f42a673177@${params.JENKINS_URL}/crumbIssuer/api/xml?xpath=concat\\(//crumbRequestField,":",//crumb\\)'""",returnStdout: true)      
